...
public class DealerHelper extends DriverHelper {
	...
	public void assertFindByStateSection() {
		print("Assert find By State section.");
		locator = Locator.Dealer.Find_By_State.value;
		Assert.assertTrue(isTextPresent(locator, Strings.SectionHeading.Dealer_By_State.value),
				"Element Locator :" + locator + " Not found");
	}
	...
	public void clickOnWebsiteMapAndEmailLinksAndAssertResultPage(){
	 ...
	 * @throws AWTException 
	 */
	public void clickOnWebsiteLinkAndAssertResultPage(){
		print("Click On Website Link And Assert Result Page");
		String dealerResultPage = Locator.Dealer.Dealer_ResultPage.value;
		String[] text2 = getText(dealerResultPage).split(" "); 
		String dealer = text2[0];
		print(dealer);
		String websiteURL = getWebDriver().findElement(ByLocator(Locator.Dealer.Website_Link.value)).getAttribute("href");
		Assert.assertTrue(websiteURL.contains(dealer));
	}
	 ...
	 * @throws AWTException 
	 */
	public void clickOnMapLinkAndAssertResultPage(){
		print("Click On Map Link And Assert Result Page");
		String url = getWebDriver().findElement(ByLocator(Locator.Dealer.Map_Link.value)).getAttribute("href");
		Assert.assertTrue(url.contains("maps.google.com/"));
