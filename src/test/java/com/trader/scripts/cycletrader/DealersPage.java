 ...
 * @author viveks
 *
 *         This class contains all Dealer page scenarios.
 *         ======================================================================================================
 */
public class DealersPage extends DriverTestCase {
	...
	/**
	 * ==============================================================================================================================
	 * ATD-119: User should be redirected to Motorcycle Dealers page when click on
	 * search button at Find Motorcycle Dealers page.
	 * ==============================================================================================================================
	 */
	@Test
	...
	/**
	 * ============================================================================================================
	 * ATD-120: 'New Search' button should be displayed and user redirect to 'Find
	 * Motorcycle Dealers page' when click on New Search button at Motorcycle
	 * Dealers page.
	 * ============================================================================================================
	 */
	@Test
	...
	/**
	 * ==============================================================================================================
	 * ATD-121: Nearest and name sorting options should be displayed and sorting
	 * works correctly at Motorcycles Dealer page.
	 * ===============================================================================================================
	 */
	@Test
	...
	/**
	 * ===============================================================================================================
	 * ATD-123: Call and Listing count button should be displayed on all searched
	 * dealer grid.
	 * ===============================================================================================================
	 */
	@Test
	...
	/**
	 * ================================================================================================================
	 * ATD-124: Call and Listing count button should be worked correctly and
	 * redirect to concern page on all searched dealer grid.
	 * ================================================================================================================
	 */
	@Test
	...
	/**
	 * =====================================================================================================
	 * ATD-125: User should be redirected to dealer details page when click on any
	 * dealer grid at Motorcycle Dealers page.
	 * =====================================================================================================
	 */
	@Test
	...
	/**
	 * ========================================================================================================
	 * ATD-126: Web-site, Email and Map links should be displayed below dealer image
	 * and all links redirect to concern page when click on all links at Dealer
	 * details page.
	 * 
	 * @throws AWTException
	 *             =========================================================================================================
	 */
	@Test
	public void websiteEmailMapLinksRedirectionAndAssertResultPage(){
		OpenURL("CycleTrader");
		dealerHelper.clickOnFindMotorcycleDealersLink();
		dealerHelper.assertFindMotorcycleDealersPage();
		dealerHelper.assertFindDealersFieldsAndButton();
	...
	/**
	 * ================================================================================================================
	 * ATD-127: 'Save This Search' button should be displayed on listing section and
	 * user able to save search at dealer details page.
	 * ================================================================================================================
	 */
	@Test
	...
	/**
	 * =====================================================================================================
	 * ATD-128: 'Premium', Year', 'Price' and Newly listed sorting options should be
	 * displayed on Listing section at Dealer details page and sorting work
	 * correctly.
	 * ======================================================================================================
	 */
	@Test
	...
	/**
	 * ============================================================================================
	 * ATD-166: Start over link should be displayed under filter section at dealer
	 * details page.
	 * =================================================================================================
	 */
	@Test
	...
	/**
	 * ==================================================================================================
	 * ATD-167: Filter section should be collapsed when click on Filter link at
	 * Dealer details page.
	 * ===================================================================================================
	 */
	@Test
	...
	/**
	 * ======================================================================================================
	 * ATD-168: User should be able to applied filter with keyword at dealer details
	 * page.
	 * ======================================================================================================
	 */
	@Test
	...
	/**
	 * =============================================================================================================
	 * ATD-169: User should be able to applied filter with Type, Make, Trim and
	 * category at dealer details page.
	 * =============================================================================================================
	 */
	@Test
